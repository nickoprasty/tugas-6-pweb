...
action="prosestambahbuku.php" class="ml-5">
 ...
 <label for="judul" class="col-sm-1 col-formlabel">Judul Buku</label>
 <div class="col-sm-3">
 <input type="text" name="judul" class="formcontrol" placeholder="Judul Buku">
 </div>
 </div>
 <div class="form-group row">
...
class="form-control" placeholder="Tahun Terbit">
 ...
 <div class="col-sm-3">
 <input type="text" name="kategori" class="formcontrol" placeholder="Kategori">
 </div>
 </div>
